...
| [@Haz4rdovisk](https://github.com/Haz4rdovisk) | Sidebar connection popover and companion diagnostics from [#264](https://github.com/totec448-spec/chat-on-steroids/pull/264), project Files workspace, previews, editor and attachment UI from [#242](https://github.com/totec448-spec/chat-on-steroids/pull/242), separate Projects/Chats with direct Plugins/Skills navigation from [#252](https://github.com/totec448-spec/chat-on-steroids/pull/252), and the read-only Git Changes / exact edit-review implementation adapted from [#345](https://github.com/totec448-spec/chat-on-steroids/pull/345). The #345 adaptation retains bounded Git status/diff and immutable recorded-edit evidence while excluding its Ask-agent, stage/commit/push and unrelated feature-pack changes. |
